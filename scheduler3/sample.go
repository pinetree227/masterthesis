...
func (pl *SamplePlugin) PreFilter(ctx context.Context, state *framework.CycleState, pod *v1.Pod) (*framework.PreFilterResult, *framework.Status) {
...
func (pl *SamplePlugin) PreFilterExtensions() framework.PreFilterExtensions {
        return nil
}
